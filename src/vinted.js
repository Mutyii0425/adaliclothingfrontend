    ...
    <Grid item xs={6} sm={6} md={4} lg={3} key={product.id}>
      <Link to={`/product/${product.id}`} style={{ textDecoration: 'none' }}>
        <Card sx={{
          ...
          color: darkMode ? 'white' : 'black',
          transition: 'all 0.3s ease',
          borderRadius: { xs: '6px', sm: '10px', md: '12px' }, // Kisebb lekerekítés mobil nézetben
          ...
          '&:hover': {
            transform: { xs: 'translateY(-4px)', sm: 'translateY(-8px)' }, // Kisebb hover effekt mobil nézetben
            boxShadow: darkMode
          ...
          <Box sx={{ 
            ...
            <Box sx={{
              ...
              color: 'white',
              padding: { xs: '4px 8px', sm: '6px 12px' }, // Kisebb padding mobil nézetben
              borderRadius: '20px',
              fontWeight: 'bold',
              fontSize: { xs: '0.8rem', sm: '1rem' }, // Kisebb betűméret mobil nézetben
          ...
          <CardContent sx={{ 
            ...
            {product.feltolto && (
              <Box sx={{ 
                ...
                <Avatar 
                  ...
                  sx={{ 
                    width: { xs: 20, sm: 28 }, // Kisebb avatar mobil nézetben
                    height: { xs: 20, sm: 28 },
                ...
                <Typography 
                  variant="body2" 
                  sx={{ 
                    fontSize: { xs: '0.7rem', sm: '0.8rem' }, // Kisebb betűméret mobil nézetben
                ...
                <UploaderRatingBadge 
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    // Itt átirányíthatunk a termék oldalára, vagy csak jelezzük, hogy kattintson a termékre
                    // a részletes értékelések megtekintéséhez
            ...
            <Typography 
              ...
              sx={{
                ...
                display: '-webkit-box',
                WebkitLineClamp: { xs: 1, sm: 2 }, // Csak 1 sor leírás mobil nézetben
            ...
            <Box sx={{ 
              ...
              <Typography 
                ...
                sx={{
                  color: darkMode ? '#aaa' : '#666',
                  fontWeight: 500,
                  padding: { xs: '2px 6px', sm: '3px 10px' }, // Kisebb padding mobil nézetben
                  backgroundColor: darkMode ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.05)',
                  borderRadius: '12px',
                  fontSize: { xs: '0.65rem', sm: '0.75rem' } // Kisebb betűméret mobil nézetben
                }}
              >
                Méret: {product.meret}
              </Typography>
              ...
              <Button 
                ...
                sx={{
                  ...
                  fontSize: { xs: '0.7rem', sm: 'inherit' }, // Kisebb betűméret mobil nézetben
                  padding: { xs: '2px 4px', sm: '4px 8px' }, // Kisebb padding mobil nézetben
                  '&:hover': {
